...
.car-card {{
    ...
    border: 1.5px solid {border_c}; overflow: hidden;
    margin-bottom: 8px;
}}
...
.car-name {{
    font-family: 'Barlow Condensed', sans-serif !important;
    font-weight: 800; font-size: 22px; color: {body};
    line-height: 1.1; letter-spacing: -0.3px; margin-bottom: 6px;
}}
.car-price {{
    font-family: 'Barlow Condensed', sans-serif !important;
    font-size: 26px; font-weight: 900; color: {accent};
...
.car-desc {{ font-size: 12px; color: #4B5563; line-height: 1.5; margin-bottom: 12px; }}
.badge {{
    display: inline-block; background: {accent_lt};
...
.badge-diesel {{
    ...
    border: 1px solid rgba(29,78,216,0.2); color: #1D4ED8;
    border-radius: 999px; padding: 3px 10px;
    font-size: 10px; font-weight: 700; letter-spacing: 0.5px;
    text-transform: uppercase; margin-right: 4px; margin-top: 4px;
}}
