...
# ── IMAGE LOADER ───────────────────────────────────────────────────────────────
# Hero: use a car PNG with transparent background from Wikipedia (no hotlink block)
...
#   red-lt   #FDECEA  — tint for highlights
#   text     #111111  — body
#   muted    #888888  — labels
...
/* ── BASE ── */
.stApp { background: #FAFAFA; color: #111111; font-family: 'Barlow', sans-serif; }
...
.hero {
    ...
    min-height: 300px;
    background:
        radial-gradient(ellipse at 65% 50%, rgba(192,57,43,0.10) 0%, transparent 65%),
...
.hero-left { flex: 1; z-index: 2; padding-right: 2rem; }
.hero-tag {
    display: inline-flex; align-items: center; gap: 6px;
    background: #FDECEA; border: 1.5px solid rgba(192,57,43,0.3);
    color: #C0392B; font-size: 11px; font-weight: 800;
...
.hero-car-img {
    ...
    filter: drop-shadow(0 16px 40px rgba(192,57,43,0.18))
...
.metric-card {
    ...
    padding: 20px; border: 1.5px solid #EBEBEB;
    text-align: center;
...
.mc-model { font-size: 10px; font-weight: 800; text-transform: uppercase; letter-spacing: 1.5px; color: #aaa; }
.mc-label { font-size: 11px; color: #999; margin-top: 3px; }
.mc-val {
    font-family: 'Bebas Neue', sans-serif !important;
    font-size: 36px; color: #C0392B;
...
.stSelectbox > div > div {
    background: #fff !important; border: 1.5px solid #EBEBEB !important;
...
.result-card {
    background: #fff; border-radius: 16px;
    padding: 22px; border: 1.5px solid #EBEBEB;
    margin-bottom: 14px;
    box-shadow: 0 2px 12px rgba(0,0,0,0.05);
}
.result-card.best {
...
.rc-model { font-size: 10px; font-weight: 800; text-transform: uppercase; letter-spacing: 1.5px; color: #aaa; margin-bottom: 4px; }
.rc-price {
    font-family: 'Bebas Neue', sans-serif !important;
    font-size: 44px; color: #C0392B; line-height: 1; letter-spacing: 1px;
}
.rc-pill {
...
.empty-state {
    background: #fff; border-radius: 16px; border: 1.5px dashed #EBEBEB;
    padding: 52px 24px; text-align: center;
    box-shadow: 0 2px 12px rgba(0,0,0,0.04);
}
.empty-icon { font-size: 40px; margin-bottom: 12px; }
.empty-text { font-size: 14px; color: #888; font-weight: 500; }
.empty-cta { color: #C0392B; font-weight: 700; }
...
.car-card:hover {
    ...
    box-shadow: 0 16px 48px rgba(192,57,43,0.15), 0 0 0 1.5px rgba(192,57,43,0.25);
}
.car-img-container {
...
.car-rating { font-size: 13px; font-weight: 700; color: #F59E0B; margin-bottom: 6px; }
.car-desc { font-size: 12px; color: #666; line-height: 1.55; margin-bottom: 12px; }
.badge {
...
.badge-diesel {
    ...
    border: 1px solid rgba(59,130,246,0.3); color: #2563EB;
    border-radius: 999px; padding: 3px 10px;
    font-size: 10px; font-weight: 700; letter-spacing: 0.5px;
    text-transform: uppercase; margin-right: 4px; margin-top: 4px;
}
...
.no-result {
    ...
    border: 1.5px dashed #EBEBEB; border-radius: 16px;
    color: #aaa; font-size: 14px; font-weight: 500;
    background: #fff;
}
.stAlert { border-radius: 12px !important; font-weight: 500 !important; }
.footer { text-align: center; color: #bbb; font-size: 12px; font-weight: 600; letter-spacing: 1px; text-transform: uppercase; padding: 20px 0 4px; }
</style>
"""
