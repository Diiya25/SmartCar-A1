        ...
        if len(results) == 0:
            ...
            for col, (_, row) in zip(cols, results.iterrows()):
                ...
                with col:
                    ...
                    st.markdown(f"""
<div class='car-card' style='border-top-left-radius:0; border-top-right-radius:0;'>
  <div class='car-body'>
    <div class='car-brand'>{row['brand']} &nbsp;·&nbsp; <span style='color:{accent};font-weight:800;'>{row['fuel'].upper()}</span></div>
